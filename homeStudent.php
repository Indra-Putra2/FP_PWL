...
<div class="container-fluid slide">
    ...
    <div class="col">
        <h2 style="color:purple; text-align:center"><i>Layanan Perpustakaan Universitas Amikom Yogyakarta</i></h2>
        <p style="text-align: center;">Silakan memilih menu yang terdapat pada laman User ini</p>
    </div>
    <div class="col" style="text-align:center;">
    <h2 style="color:purple; text-align:center"><i>24/7 Operational Support</i></h2>
      Bila kesulitan, Anda dapat menghubungi care center kami di bawah ini:
  ...
  <div class="row align-items-start">
    <div class="col">
    <img width=100% height=400px src="images/library1.jpg">
    </div>
    <div class="col">
    <img width=100% height=400px src="images/library2.jfif">
    </div>
    <div class="col">
    <img width=100% height=400px src="images/library3.jfif">
    </div>
</div>
